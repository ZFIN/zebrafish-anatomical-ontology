These notes are for the EDITORS of zfa
...
Make sure you have an ID range in the [idranges file](zfa-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [zfa-edit.owl](zfa-edit.owl)

** DO NOT EDIT zfa.obo OR zfa.owl in the top level directory **

[../../zfa.owl](../../zfa.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/cerivs/zebrafish-anatomical-ontology) for details.
 ...
 * [zfa-idranges.owl](zfa-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/zfa_terms.txt file
...
Note: the zfa_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as zfa.owl and zfa.obo and places
 ...
 * https://github.com/cerivs/zebrafish-anatomical-ontology/releases
 * https://github.com/cerivs/zebrafish-anatomical-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived zfa.owl (`data-version` in
zfa.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/zfa.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/zfa/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/cerivs/zebrafish-anatomical-ontology.svg?branch=master)](https://travis-ci.org/cerivs/zebrafish-anatomical-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/cerivs](https://travis-ci.org/profile/cerivs)
 2. click the "Sync account" button
 3. Click the tick symbol next to zebrafish-anatomical-ontology
